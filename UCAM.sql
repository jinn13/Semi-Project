...
-- 성수님께서 24일날 추가하신 문구(하기 전 테이블의 데이터 지워야 에러뜨지 않음)
...
INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 1, '1:1 문의 1', '안녕하세요, 배송 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 2, '1:1 문의 1', '안녕하세요, 신고 회원 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 2, '1:1 문의 1', '안녕하세요, 환불 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 2, '1:1 문의 1', '안녕하세요, 차단 회원 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
...
BEGIN
    FOR N IN 1..4
    LOOP
        INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 1, '1:1 문의 ' || SEQ_QBOARD_NO.CURRVAL, '안녕하세요, 배송 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
        INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 1, '1:1 문의 ' || SEQ_QBOARD_NO.CURRVAL, '안녕하세요, 신고 회원 관련 문의 드립니다.','파일명.txt', 'Y', DEFAULT);
        INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 1, '1:1 문의 ' || SEQ_QBOARD_NO.CURRVAL, '안녕하세요, 환불 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
        INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 1, '1:1 문의 ' || SEQ_QBOARD_NO.CURRVAL, '안녕하세요, 차단 회원 관련 문의 드립니다.', '파일명.txt', 'Y', DEFAULT);
    END LOOP;
...
INSERT INTO QBOARD VALUES(SEQ_QBOARD_NO.NEXTVAL, 2, '1:1문의', '안녕안녕', '파일명1.jpg', DEFAULT, DEFAULT);
UPDATE QBOARD SET OTO_TITLE='하이하이',OTO_CONTENT='하이루이',OTO_FILENAME='파일명은없음',OTO_DATE=SYSDATE WHERE OTO_NO=24;
