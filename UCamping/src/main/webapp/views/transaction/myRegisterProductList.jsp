...
<head>
    ...
    <link rel="stylesheet" href="${ path }/resources/css/myRegisterProductList.css">
...
<body>
                                                        ...
                                                        <div class="card_box">
                                                            <div class="img_wrap">
                                                                <div class="img_outside_box">
                                                                    <div class="img_box">
                                                                        <img class="thumbnail_img" src="${ path }/resources/images/item/item27.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="cont">
                                                ...
                                                <li class="main_col_3">
                                                    <a class="card card_list" href="">
                                                        <div class="card_box">
                                                            ...
                                                            <div class="cont">
                                                                <div class="item_title">쿨거원해요</div>
                                                                <div class="item_price profile_price">
                                                                    140,000
                                                                    원
                                                                </div>
    ...
    <script type="text/javascript" src="${ path }/resources/js/myRegisterProductList.js"></script>
</body>
</html>
